...
| Late | [SCRUM-38](https://lotrbg.atlassian.net/browse/SCRUM-38) | Write unit tests for all 11 API endpoints |
| Late | [SCRUM-39](https://lotrbg.atlassian.net/browse/SCRUM-39) | Document all 11 API endpoints |
...
7. **SCRUM-38** — Unit tests for all 11 API routes (can add tests incrementally per endpoint to avoid a big bang).
